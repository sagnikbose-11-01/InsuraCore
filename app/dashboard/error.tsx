...
// Local error boundary for the customer dashboard layout.
// ============================================================
  ...
  return (
    <div className="bg-[oklch(15%_0.02_230/0.75)] border border-[oklch(28%_0.08_230)] backdrop-blur-md rounded-2xl p-8 max-w-xl mx-auto text-center space-y-5 animate-fade-in my-8">
      ...
      <div className="space-y-1.5">
        <h3 className="text-base font-bold text-[var(--color-base-100)]">Failed to load dashboard component</h3>
        <p className="text-xs text-[var(--color-base-500)] leading-relaxed max-w-sm mx-auto">
          An error occurred while loading this section. You can try reloading or navigate using the sidebar.
        </p>
      </div>
