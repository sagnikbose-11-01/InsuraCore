...
export const metadata: Metadata = {
  ...
  description: 'Create a free InsuraCore account to purchase insurance policies and manage claims.',
};
    ...
    <div className="min-h-screen hero-bg flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md animate-fade-in">
        <div className="glass-card p-8">
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="mt-1 text-sm text-[var(--color-base-500)]">
              Join InsuraCore and protect what matters
            </p>
          </div>
        ...
        <p className="mt-6 text-center text-xs text-[var(--color-base-600)]">
          ...
          <span className="text-[var(--color-base-500)]">Terms of Service</span>.
        </p>
      </div>
    </div>
  );
